...
#
# Script generated by Vivado on Fri Sep 26 18:03:33 +07 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../lab1.gen/sources_1/bd/system/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../lab1.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
